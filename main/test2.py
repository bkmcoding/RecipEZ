...
fig = px.scatter_3d(
    df, x='x', y='y', z='z',
    color='major_category',  # Colored by our clean semantic tiers
    hover_name='name', 
    hover_data={'x': False, 'y': False, 'z': False, 'major_category': False},
...
export_df = df[['id', 'name', 'x', 'y', 'z', 'major_category']]
